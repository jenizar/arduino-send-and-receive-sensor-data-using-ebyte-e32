...
#include "DHT.h"
#define DHTPIN 9    // pin D9 - Digital pin connected to the DHT sensor
...
void loop()
{
  ...
  *(float*)(message.temperature) = Sensor1Data;
    *(float*)(message.humidity) = Sensor2Data;
      *(float*)(message.lightd) = Ldr;
